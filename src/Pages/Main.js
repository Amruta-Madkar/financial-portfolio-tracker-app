...
import Addstocks from '../Components/AddStocks/Addstocks';
 ...
 class Main extends Component {
     ...
     componentDidMount(){
        axios.get("https://fin-tracker-e5ed8.firebaseio.com/tickers.json")
        .then((response)=>{
        ...
        axios.get("https://fin-tracker-e5ed8.firebaseio.com/stockadd.json")
        .then((response)=>{
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://fin-tracker-e5ed8.firebaseio.com/tickers.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://fin-tracker-e5ed8.firebaseio.com/stockadd/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://fin-tracker-e5ed8.firebaseio.com/stockadd.json', {
                            ...
                            axios.delete(`https://fin-tracker-e5ed8.firebaseio.com/tickers/${id}.json`)
                            .then((response)=>{
